...
import { j as joinURL } from './nuxi.a6273a0c.mjs';
import assert from 'node:assert';
import process$1 from 'node:process';
import path from 'node:path';
import v8 from 'node:v8';
import { format, inspect } from 'node:util';
import { i as isAbsolute } from './nuxi.610c92ff.mjs';
...
async function importModule(id, url = import.meta.url) {
  ...
  return import(pathToFileURL$1(resolvedPath).href).then(interopDefault);
}
